//! Fin flutter by NACA TN 4197's criterion: a 54 mm rocket's fins, the dynamic pressure at which
//! they would flutter in each material with a cited shear modulus, their flutter speed at two
//! heights, and how far below it the flight stays at its peak dynamic pressure.
//!
...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    println!(
        ...
        panel.aspect_ratio, panel.taper_ratio, panel.thickness_ratio
    );

    // Its flight on an I175, for the peak dynamic pressure.
    let simulation = Simulation::new(
        &rocket,
        "i175",
        Environment::standard(Geodetic::from_degrees(35.0, -106.0, 200.0)?)?,
        Rail::vertical(3.0),
