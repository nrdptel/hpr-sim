...
//! row, and on the committed Arcas Robin nose above about Mach 4 it puts most of the march's
//! elements into `η < 0` ([issue #108](https://github.com/nrdptel/hpr-sim/issues/108)), where
//! the answer moves with the element count. [`handover_angle_capped_rad`] takes the cap as a
//! parameter so both ends are measured rather than argued.
//!
