...
doesn't and how far to trust it; [docs/getting-started.md](docs/getting-started.md) flies a first
rocket; [docs/accuracy.md](docs/accuracy.md) has every validation result.
