...
| Clustered motors | [4× B4-4] | -0.71% | 0.37 | 143.1 | -0.79% | — | — | — | — | — | — |
| Clustered motors | [4× C6-3] | +9.43% | 2.59 | 308.6 | -0.72% | — | — | — | — | — | yes |
| Clustered motors | [4× C6-5] | -0.55% | 0.59 | 308.6 | -0.72% | — | — | — | — | — | — |
...
| ARC payload rocket | [None; F50T-9] | stages hpr can't separate as written |
| Deployable payload | [None; A8-3] | stages hpr can't separate as written |
| Deployable payload | [None; B4-4] | stages hpr can't separate as written |
| Deployable payload | [None; C6-3] | stages hpr can't separate as written |
| Deployable payload | [None; C6-5] | stages hpr can't separate as written |
| Deployable payload | [None; C6-7] | stages hpr can't separate as written |
