...
inputs, and comparing the numbers. It is the third of four [levels of evidence][levels], and it
...
evidence in four [levels][levels]: analytic and unit tests, component references such as tables
...
[levels]: https://github.com/nrdptel/hpr-sim/blob/main/docs/VALIDATION.md#principles
