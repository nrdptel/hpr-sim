...
- **Last updated:** 2026-09-18 (M2.1d1 shipped; M2.1d2 and M2.1d3 not started; the path in wind split in two)
...
- **Resume here, M2.1d2:** zero-wind copies of Juno III, Calisto and Bella Lui in
  `validation/oracles/rocketpy/flight.py`, the fixture regenerated by hand (ADR-022), and
  `flight-*-calm` cases, drifts at 3% (issue #50: calm air agrees to 1.3-3.7%).
