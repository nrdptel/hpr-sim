...
| [ADR-068: OpenRocket's flights of the public designs, and what its metric words mean][adr-068] | [M2.2d](#m2-2d), flights against OpenRocket, splits in two. OpenRocket 24.12 flies all 57 configurations of the public designs with a motor in calm air, and a record keeps each summary word beside the quantities of its own time series. Its deployment speed is the last deployment's, interpolated at the event; its optimum delay is not measured and is withheld; any other version's words are withheld too ([L80](#l80)). A metric whose event never happened is withheld, never scored as 0 ([L81](#l81)). | [`.ork`: what the summary words mean](format/ork.md#what-the-summary-words-mean) |
...
| <a id="m2-2d"></a>[M2.2d][phase-1] | Flights to apogee on the public designs, against OpenRocket, split into [M2.2d1](#m2-2d1) and [M2.2d2](#m2-2d2) below by [ADR-068][adr-068] | not yet done |
| <a id="m2-2d1"></a>[M2.2d1][phase-1] | OpenRocket 24.12 flies the public designs, and what each of its summary words measures is written down per tool and version; a metric for an event that never happened is withheld | done |
| <a id="m2-2d2"></a>[M2.2d2][phase-1] | hpr flies the same configurations, in a report against OpenRocket's apogee, largest speed and stability margin | not yet done |
...
| <a id="l80"></a>[L80][lessons-validation] | Same word, different quantity: the deployment and ground-hit speeds and the optimum delay differ by tool and OpenRocket version | [M2.2d1](#m2-2d1) |
