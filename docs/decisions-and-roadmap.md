...
| [ADR-048: What a marched flare is worth][adr-048] | That TN D-4865 model 2's readings are committed and compared: an 18.5° flare read within 7% of the wind tunnel through Mach 2.3 and 50% high where that flare's boundary layer separates, with no reading at all below Mach 1.5289, where drawing the flare out to its shock's limit lands past the march's own | [Aerodynamics](physics/aero.md#what-a-marched-flare-is-worth) |
