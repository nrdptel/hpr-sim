...
| [ADR-049: What a step in radius costs][adr-049] | That a step's cost is measured and published rather than modelled: it takes the whole body off the shock-expansion method, worth −8.65% and 1.03 calibres at its 2.7e−11 m threshold and up to −12.55% and 1.36 calibres at 2 mm; and that stopping the march at the step instead was built, measured and rejected, because it adds two larger jumps of its own | [Aerodynamics](physics/aero.md#a-step-in-radius) |
