...
| [ADR-048: What a marched flare is worth][adr-048] | That TN D-4865 model 2's readings are committed and compared: an 18.5° flare read −1.9% and +7.0% against the wind tunnel at Mach 1.9 and 2.3, +13.4% at 2.96 and about +51% at 3.95 and 4.63 where that flare's boundary layer is separated, with no reading at all below Mach 1.5289, where drawing the flare out to its shock's limit lands past the march's own | [Aerodynamics](physics/aero.md#what-a-marched-flare-is-worth) |
