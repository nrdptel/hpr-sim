...
| <a id="m2-2b"></a>[M2.2b][phase-1] | OpenRocket's mass conventions and roll inertia, split into [M2.2b1](#m2-2b1) to [M2.2b4](#m2-2b4) below; the stored results moved from the third to the fourth when [ADR-062][adr-062] split the fins off | not yet done |
