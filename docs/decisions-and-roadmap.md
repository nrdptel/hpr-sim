...
| <a id="m2-2d2"></a>[M2.2d2][phase-1] | hpr flies the configurations of that record it can fly, in a report against OpenRocket's apogee, largest speed and stability margin | not yet done |
