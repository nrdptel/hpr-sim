...
| [`hpr_aero`](api/hpr_aero/index.html) | Aerodynamics: normal force, centre of pressure and drag to Mach 5, and drag tables | The drag compared with [RASAero II](glossary.md#rasaero-ii)'s through Mach 2 ([M1.8b2](decisions-and-roadmap.md#m1-8b2)); roll and damping ([M1.8c](decisions-and-roadmap.md#m1-8c)) | [Aerodynamics](physics/aero.md) |
