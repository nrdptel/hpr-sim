...
| [`hpr_aero`](api/hpr_aero/index.html) | Aerodynamics: normal force, centre of pressure and drag to Mach 5, and tables from other programs for the drag and the normal force | In a flight the body's normal force faster than sound is still slender-body theory's, which reads low past Mach 3; the method that adds a cylinder's lift behind the nose is not yet flown ([M1.8e2](decisions-and-roadmap.md#m1-8e2)) | [Aerodynamics](physics/aero.md) |
