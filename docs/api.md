...
| [`hpr_flightdata`](api/hpr_flightdata/index.html) | Reading a flight log from any logger, and the readings taken off it, each saying where it came from. Needs no design and no simulation, so a flight can be analysed on its own | [M7.1](decisions-and-roadmap.md#m7-1) to [M7.2](decisions-and-roadmap.md#m7-2) |
| [`hpr_forensics`](api/hpr_forensics/index.html) | A flown flight against a simulation of it: what differs, what that says about drag, mass, impulse and wind, and what went wrong | [M7.3](decisions-and-roadmap.md#m7-3) to [M7.4](decisions-and-roadmap.md#m7-4) |
