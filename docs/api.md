...
| [`hpr_aero`](api/hpr_aero/index.html) | Aerodynamics: normal force, centre of pressure and drag to Mach 5, and tables from other programs for the drag and the normal force | A cited method for the body's normal force faster than sound, which reads low past Mach 3 ([M1.8e](decisions-and-roadmap.md#m1-8e)) | [Aerodynamics](physics/aero.md) |
