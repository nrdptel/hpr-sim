...
| [`hpr_aero`](api/hpr_aero/index.html) | Aerodynamics: normal force, centre of pressure and drag to Mach 5, and tables from other programs for the drag and the normal force | Faster than sound a flight takes a pointed nose and its cylinder from the [shock-expansion method](physics/aero.md#the-body-faster-than-sound-in-a-flight); a rocket with a boattail or a blunt tip keeps slender-body theory, which reads low past Mach 3, until [M1.8e3](decisions-and-roadmap.md#m1-8e3), the boattail and crossflow | [Aerodynamics](physics/aero.md) |
