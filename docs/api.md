...
| [`hpr_aero`](api/hpr_aero/index.html) | Aerodynamics: normal force and centre of pressure to Mach 5, drag and drag tables | drag at Mach 1 and above ([M1.8b](decisions-and-roadmap.md#m1-8b)) | [Aerodynamics](physics/aero.md) |
