...
- **Measured, four times blunter.** Butler, Sears and Pallas (AFATL-TR-77-8, 1977, Table 3,
  ...
  (N23, 4.15 in long against 4.80). The tip changed `C_Nα` by nothing at Mach 1.5 and 2 (0.048 and
  0.053 per degree both), −1.7% at Mach 3 (0.060 to 0.059) and −9.5% at Mach 4 (0.063 to 0.057).
...
`(0.055/0.25)ⁿ` with `n` from 1 to 2 (an assumption), on hpr's slope at `α → 0`: nothing at Mach
1.5 and 1.8, a loss of 0.002 to 0.011 at 2.3 and 2.96, and 0.015 to 0.07 at 3.96 and 4.63.
...
tunnel's `b` (and away from the middle points' line past Mach 3).
...
below 1, so the likelier change raises hpr's slope. The boattail carries some of the nose's
loading forward, and that part of its share, at most 0.18, scales the same way.
