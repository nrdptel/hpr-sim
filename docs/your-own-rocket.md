...
- **This program computes its margin by hand.** hpr also gives the margin through the flight, and
  an optimum ejection delay, as [Flight metrics](physics/metrics.md) shows.
