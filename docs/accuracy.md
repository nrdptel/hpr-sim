...
| [Flight metrics](physics/metrics.md) | ✓ the boost's peak, the boattail margins and the landing placement against hand calculations; max q and top Mach against a 1 ms record; the flight margin and the optimum delay against hpr's own models and a flight with no recovery | — | — | — |
