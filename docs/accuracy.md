...
| [Aerodynamics](physics/aero.md#what-a-marched-flare-is-worth) | NASA TN D-4865's model 2, the one flared body in the sources whose normal force and pitching moment are printed: a blunt 2.75° cone with an 18.5° flare, Mach 1.50 to 4.63, six readings, three of them with its boundary layer separated; no target ([fixture][flare-fixture]) | like for like (at its plotted angles, body lift included) the normal-force slope −1.9% at Mach 1.90, +7.0% at 2.30 and +13.4% at 2.96, with the centre of pressure within 0.05 calibres; then +51.5% and +50.4% at Mach 3.95 and 4.63, where the report's own shadowgraphs show the flare's boundary layer separated ahead of the juncture — the same two rows read +29.7% and +32.1% on the report's unflared model 1, so the flare itself adds 21.7 and 18.3 points there and between −1.9 and +0.9 below. Below Mach 1.528869598743478 there is no reading at all: drawing the flare out to the steepest turn its shock holds lands past the steepest the march itself takes |
