...
| [Aerodynamics](physics/aero.md#boattails-faster-than-sound) | conical boattails measured in six NACA and NASA reports, jet off, Mach 0.6 to 3.24: the boattail's own pressure drag (47 readings) and the base pressure behind it (12) ([drag fixture][drag-fixture]) | attached boattails of 10° or gentler from Mach 1.2: −6.3% to +17.4% (19 readings); from Mach 1.0 to 1.1, −18.2% to −5.4% (4); 16° in a boundary layer a fifth of the diameter thick, +26.4% to +54.2% (9); separated 30° and 45°, −2.8% to +6.6% (3). The base drag behind them within 0.0102 of the measured on the cylinder's area, 10 of 12 within 0.004, though behind small bases that is up to about 40% of the base's own drag. Below Mach 0.9, Niskanen's rule gives long boattails nothing where they measure 0.024 to 0.051 |
